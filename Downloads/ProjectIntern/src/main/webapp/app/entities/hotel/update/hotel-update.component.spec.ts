...
describe('Hotel Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call HotelAdministrateur query and add missing value', () => {
      ...
      const hotelAdministrateur: IHotelAdministrateur = { id: 28596 };
      hotel.hotelAdministrateur = hotelAdministrateur;

      const hotelAdministrateurCollection: IHotelAdministrateur[] = [{ id: 21581 }];
    ...
    it('Should update editForm', () => {
      const hotel: IHotel = { id: 456 };
      const hotelAdministrateur: IHotelAdministrateur = { id: 22299 };
      hotel.hotelAdministrateur = hotelAdministrateur;
