...
describe('Service Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Partenaire query and add missing value', () => {
      ...
      const partenaire: IPartenaire = { id: 3341 };
      service.partenaire = partenaire;

      const partenaireCollection: IPartenaire[] = [{ id: 18662 }];
    ...
    it('Should call Hotel query and add missing value', () => {
      const service: IService = { id: 456 };
      const hotel: IHotel = { id: 1145 };
      service.hotel = hotel;

      const hotelCollection: IHotel[] = [{ id: 8605 }];
    ...
    it('Should call Reservation query and add missing value', () => {
      const service: IService = { id: 456 };
      const reservation: IReservation = { id: 15726 };
      service.reservation = reservation;

      const reservationCollection: IReservation[] = [{ id: 21044 }];
    ...
    it('Should update editForm', () => {
      const service: IService = { id: 456 };
      const partenaire: IPartenaire = { id: 17286 };
      service.partenaire = partenaire;
      const hotel: IHotel = { id: 19344 };
      service.hotel = hotel;
      const reservation: IReservation = { id: 1669 };
      service.reservation = reservation;
