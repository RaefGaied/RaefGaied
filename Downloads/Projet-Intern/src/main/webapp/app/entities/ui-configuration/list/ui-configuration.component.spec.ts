...
import { sampleWithRequiredData } from '../ui-configuration.test-samples';
import { UIConfigurationService } from '../service/ui-configuration.service';

import { UIConfigurationComponent } from './ui-configuration.component';
import SpyInstance = jest.SpyInstance;

describe('UIConfiguration Management Component', () => {
  let comp: UIConfigurationComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(UIConfigurationComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.uIConfigurations?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to uIConfigurationService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getUIConfigurationIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getUIConfigurationIdentifier).toHaveBeenCalledWith(entity);
