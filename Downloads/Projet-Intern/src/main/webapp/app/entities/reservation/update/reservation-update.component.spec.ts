...
describe('Reservation Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Hotel query and add missing value', () => {
      ...
      const hotel: IHotel = { id: 4879 };
      reservation.hotel = hotel;

      const hotelCollection: IHotel[] = [{ id: 21093 }];
    ...
    it('Should call User query and add missing value', () => {
      const reservation: IReservation = { id: 456 };
      const user: IUser = { id: 16068 };
      reservation.user = user;

      const userCollection: IUser[] = [{ id: 25574 }];
    ...
    it('Should update editForm', () => {
      const reservation: IReservation = { id: 456 };
      const hotel: IHotel = { id: 14795 };
      reservation.hotel = hotel;
      const user: IUser = { id: 23313 };
      reservation.user = user;
