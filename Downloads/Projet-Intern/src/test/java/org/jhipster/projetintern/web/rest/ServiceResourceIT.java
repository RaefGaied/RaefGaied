...
import org.jhipster.projetintern.repository.ServiceRepository;
import org.jhipster.projetintern.service.dto.ServiceDTO;
import org.jhipster.projetintern.service.mapper.ServiceMapper;
...
class ServiceResourceIT {
    ...
    void partialUpdateServiceWithPatch() throws Exception {
        ...
        partialUpdatedService.description(UPDATED_DESCRIPTION).prix(UPDATED_PRIX).capacite(UPDATED_CAPACITE);
